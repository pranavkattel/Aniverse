...
public class AnimeHouse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAddAnimes1 = new javax.swing.JButton();
        ...
        pnlMainScreen.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 10, -1, 50));
        ...
        pnlMainScreen.add(lblSubTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 50, 410, 60));
        ...
        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/aniverse/resources/adding.jpg"))); // NOI18N
        jLabel24.setPreferredSize(new java.awt.Dimension(1366, 400));

        jLabel25.setText("Treanding Now");

        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/aniverse/resources/anotherr.jpg"))); // NOI18N

        jLabel27.setBackground(new java.awt.Color(255, 204, 255));
        jLabel27.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/aniverse/resources/anotherr.jpg"))); // NOI18N

        jLabel29.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/aniverse/resources/anotherr.jpg"))); // NOI18N
        ...
        btnAddAnimes1.setBackground(new java.awt.Color(153, 0, 153));
        btnAddAnimes1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnAddAnimes1.setForeground(new java.awt.Color(255, 255, 255));
        btnAddAnimes1.setText("Sort");
        btnAddAnimes1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddAnimes1ActionPerformed(evt);
            }
        });

        txtFldSearchAnime.setText("jTextField1");
        ...
        pnlAnimeTableLayout.setHorizontalGroup(
            ...
            .addGroup(pnlAnimeTableLayout.createSequentialGroup()
                ...
                .addGap(282, 282, 282)
                .addComponent(txtFldSearchAnime, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27)
            ...
            .addGroup(pnlAnimeTableLayout.createSequentialGroup()
                ...
                .addGroup(pnlAnimeTableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlAnimeTableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txtFldSearchAnime, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jButton1)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jtabAnimeList.addTab("Top Animes", jPanel3);
...
// TODO add your handling code here:    
    ...
    private void btnAddAnimes1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddAnimes1ActionPerformed
        // TODO add your handling code here:
//        SelectionSort selectionSort = new SelectionSort();
//        List<AnimeModel> sortedList = selectionSort.sortByScore(AnimeList, false); // false for descending
//        loadAnimeListToTable(sortedList);
           MergeSort mergeSort = new MergeSort();
        List<AnimeModel> sortedList = mergeSort.sort(AnimeList);
        loadAnimeListToTable(sortedList); // Assuming you want to update the table after sorting
    }//GEN-LAST:event_btnAddAnimes1ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        SelectionSort selectionSort = new SelectionSort();
        List<AnimeModel> sortedList = selectionSort.sortByEpisodes(AnimeList, true);
        BinarySearch search = new BinarySearch();
        AnimeModel searchedData = search.searchByName(txtFldSearchAnime.getText().trim(), sortedList, 0, sortedList.size()-1);
    ...
    private javax.swing.JButton btnAddAnimes1;
